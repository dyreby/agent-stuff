...
- Re-request review when changes warrant verification; skip for mechanical fixes answered to satisfaction. When re-requesting, call out what we think they'll care most about
